...
HC_MIS PROT_MIS_HC
HC_BOTH PROT_PTV_HC,PROT_SPLICE_HC,PROT_MIS_HC
LC_LOF PROT_PTV_LC,PROT_SPLICE_LC
LC_MIS PROT_MIS_LC,PROT_INFRAME
LC_BOTH PROT_PTV_LC,PROT_SPLICE_LC,PROT_MIS_LC,PROT_INFRAME
EOL


mask_files+=("ctrl_masks.txt")
...
if ! parallel \
  ...
  --phenoColList react.time,all.iq2,iq \
  ...
  --approx \
  --rgc-gene-p \
  --vc-tests skato-acat,acato-full,skat,skato \
  --aaf-bins 0.00001 \
  --vc-maxAAF 0.00001 \
  --minMAC 1 \
  --apply-rint \
